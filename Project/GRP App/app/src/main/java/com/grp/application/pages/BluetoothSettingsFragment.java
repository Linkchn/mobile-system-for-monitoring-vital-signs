...
import com.grp.application.utils.ColorUtil;
import com.grp.application.utils.PermissionHelper;
...
public class BluetoothSettingsFragment extends Fragment {
    ...
    private void startBluetoothDiscovery() {
        ...
        txtSearching.setText("Searching for your Bluetooth scale");
        ...
        progressHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                txtSearching.setText("Search finished");
